...
class ComprasController extends Controller
{
    ...
    if (isset($_GET['idproveedor'])) {
        $searchModel = new ComprasSearch([ 'idproveedor' => $_GET['idproveedor'], ] );
    } else {
 ...
 /*   public function actionIndex()
    ...
    public function actionPagos($id)
    {
 	...
 	//	$pagos = new Pagos();
		//$pagos->hasMany(Pagos::className(),['idcompra'=>$id] );
       // $model = $pagos->findModel($id);

      //  if ($pagos->load(Yii::$app->request->post()) ) {
         //   return $this->redirect(['view', 'id' => $model->id]);
       /* } else {
            return $this->render('update', [
                'model' => $model,
            ]); */
			//return $this->render('index', ['model' => $pagos,   ]);
        //}

			$pagos = new Pagos();
            return $this->render('indexpagos', ['model' => $pagos, 'idcompra' => $id  ]);
 		//return $this->redirect(['pagos', 'idcompra' => $id]);
     ...
     * @return mixed
     */
    public function actionIndexpagos($idcarrera)
    {
